...
type: "Component"
title: "Ящик станції"
description: "Один саморобний ящик на станцію І генератор: фанера, мінеральна вата, герметична перегородка між відсіками, вихлоп трубою назовні (DEC-148 від 16.08). Питання «"
resource: "https://hero-armor.github.io/enclosure.html"
tags: ["enclosure"]
system_status: "in-design"
generated: { by: "process:site-build" }
---

Один саморобний ящик на станцію І генератор: фанера, мінеральна вата, герметична перегородка між відсіками, вихлоп трубою назовні (DEC-148 від 16.08). Питання «фільтр-бокс чи кулер із водою» закрите: кулер скасовано, бо поруч працює генератор. Повітря розведено по відсіках — станцію піддуваємо крізь фільтр, генератор продуваємо наскрізь. Головне невирішене — вага: близько 117 кг разом із залізом.
...
* [Замовити пару ящиків Sterilite 40 gal у Target ($176.99, доставка наступного дня)](/tasks/zamovyty-paru-iashchykiv-sterilite-40-gal-u-target-176-99-do.md) — готово
* [Виміряти реальну висоту ящика Sterilite — 457 мм це з колесами чи без](/tasks/vymiriaty-realnu-vysotu-iashchyka-sterilite-457-mm-tse-z-kol.md) — готово
...
* [Підтвердити розводку повітря: станційний відсік — нагнітання через фільтр, генераторний — витяжка](/tasks/pidtverdyty-rozvodku-povitria-stantsiinyi-vidsik-nahnitannia.md) — до роботи
...
* [Датчик чадного газу Kidde на батарейках](/bom/datchyk-chadnoho-hazu-kidde-na-batareikakh.md) — $27.79 / шт, купити
* [Вогнегасник First Alert ABC з металевим кронштейном](/bom/vohnehasnyk-first-alert-abc-z-metalevym-kronshteinom.md) — $34.95, купити
...
* [Алюміній рифлений на підлогу подіуму — McMaster 4917T31, 48×48″, 1/16″, клейка основа](/bom/aliuminii-ryflenyi-na-pidlohu-podiumu-mcmaster-4917t31-48-48.md) — $145.45/лист · $727.25 за 5, купити
