...
def build() -> str:
    ...
    o.append(t(ox, oy2 + bh2 + 34, "станційний бік — нагнітання крізь фільтр, надлишковий тиск · "
                                   "генераторний — наскрізний продув із витяжкою вгору", 10.5, DIM))
    o.append(t(ox, oy2 + bh2 + 48, "перегородка мусить бути ГЕРМЕТИЧНОЮ, інакше витяжка генератора "
                                   "висмокче тиск зі станційного боку", 10.5, RED, "start", "600"))
