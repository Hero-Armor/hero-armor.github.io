...
def build() -> str:
    ...
    o.append(t(cx + dw + 16, fy + 120, "Задні двері ведуть просто до ліжок — повз кухню нести не треба.",
               11, ORANGE))
    o.append(t(cx + dw + 16, fy + 142, "ЩО ЗАМІРЯТИ В БОГДАНА:", 11, ORANGE, "start", "700"))
    for i, line in enumerate(["ширину і висоту ЗАДНІХ дверей",
                              "висоту порога над землею",
                              "ширину проходу в найвужчому місці"]):
        o.append(t(cx + dw + 16, fy + 162 + i * 18, "· " + line, 11, DIM))
