...
Друге, на чому легко помилитись: жовтий світлодіод має пряму напругу близько 2.1 В,
а не 3 В. Три вольти — це білий і синій. Якщо порахувати резистор на 3 В, а поставити
жовтий, струм вийде більший за задуманий, і резистор буде грітись. Тому в таблиці
обидва випадки.
...
def build() -> str:
    ...
    o.append(t(cols[0], ty + 68 + len(calc_rows()) * 19 + 16,
               "Зеленим — рекомендація: 10 мА. Для індикатора яскравість майже та сама, "
               "а тепла в резисторі вдвічі менше.", 11.5, GREEN))
